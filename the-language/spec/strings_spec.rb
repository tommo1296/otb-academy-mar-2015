...
END
  ...
  it "should increment the number" do
    string = "AAA"
    string = string.succ

    expect( string ).to eq ( "AAB" )
  end

  it "should merge the characters" do
    string = "Random"
    expect(string.tr('anm', '123')).to eq( "R12do3" )
  end

  it "should squeeze" do
    string = "Hello this is a silly testty"

    expect(string.squeeze).to eq "Helo this is a sily testy"
  end

  it "should partition" do
    string = "This should be leave 5"

    expect(string.partition("l")).to eq ["This shou","l","d be leave 5"]
  end
end
